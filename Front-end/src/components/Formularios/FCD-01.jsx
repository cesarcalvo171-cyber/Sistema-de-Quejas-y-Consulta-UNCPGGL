        ...
        <Alert variant="succes" className="w-[600px]">
          ...
          <AlertDescription>
            ...
            <p>
              ...
              <br />
              <br />
              Introduzca sus datos personales, se recomienda cumplimentar el
              campo de Correo Electrónico para poder enviarle la confirmación de
              recepción de su solicitud..
              <br />
              <br />
              Los campos obligatoriamente requeridos se señalan mediante el
              icono asterisco
              <br />
              <br />
              Este formulario esta adaptado a dispositivos móviles. Si lo desea
              puede añadirlo a los marcadores de su dispositivo para una mayor
              comodidad.
            </p>
          </AlertDescription>
        </Alert>
                  ...
                  {R_universitaria === "Otro" && (
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="font-semibold uppercase">
                            Especifique otra relación con la universidad
                          </FormLabel>
                          <FormControl>
                            <Input
                  ...
                  {Area === "Otro" && (
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="font-semibold uppercase">
                            Especifique otra Area de la universidad
                          </FormLabel>
                          <FormControl>
                            <Input
                              placeholder="Especifique aquí"
                  ...
                  {Tipo_denuncia === "Otro" && (
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="font-semibold uppercase">
                            Especifique otro tipo de denuncia
                          </FormLabel>
                          <FormControl>
                            <Input
                              placeholder="Especifique aquí"
                  ...
                  {persona_involucrada === "Informatica" && (
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="font-semibold uppercase">
                            Nombre del Persona involucrada
                          </FormLabel>
                          <FormControl>
                            <Select
                              onValueChange={field.onChange}
                            ...
                            >
                              ...
                              <SelectContent>
                                <SelectItem value="pepito">pepito</SelectItem>
                                <SelectItem value="pepito1">pepito1</SelectItem>
                              </SelectContent>
                            </Select>
                          </FormControl>
                          <FormMessage className="text-red-500" />
